...
if __name__ == "__main__":
    ...
    regular_font = os.path.join(base_dir, 'pdffonts', 'Pretendard-Regular.ttf')
    bold_font = os.path.join(base_dir, 'pdffonts', 'Pretendard-Bold.ttf')
    thin_font = os.path.join(base_dir, 'pdffonts', 'Pretendard-Thin.ttf')
    
    # 한글 폰트 등록
    pdfmetrics.registerFont(TTFont('Pretendard-Regular', regular_font))
    pdfmetrics.registerFont(TTFont('Pretendard-Bold', bold_font))
    pdfmetrics.registerFont(TTFont('Pretendard-Thin', thin_font))
    c = canvas.Canvas(os.path.join(base_dir, "output.pdf"), pagesize=A4)
    ...
    c.setLineWidth(3)  # 선의 두께
    c.line(22, height - 100, 22, height - 130)  # 세로선 좌표
    ...
    c.setStrokeColor(orange_color)
    c.setLineWidth(3)  # 선의 두께
    c.line(22, height - 284, 22, height - 314)  # 세로선 좌표
